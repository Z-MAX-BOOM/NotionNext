...
const BLOG = {
  // Important page_id！！！Duplicate Template from  https://www.notion.so/
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID ||
    '8a05f4400f5b4ff4811c8968d50173e3',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '鲨鱼', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Atlantis', // 作者简介
